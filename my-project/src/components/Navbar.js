...
export default function Navbar(){
    ...
    return(
        <div className='fixed bottom-[2dvh] w-full text-sm justify-center font-display z-10 flex sm:w-1/12 sm:flex-col sm:sticky sm:bottom-full sm:top-2 sm:left-full sm:mx-2 sm:text-lg'>
            <div className="flex flex-row space-x-2 sm:flex-col sm:space-y-2 sm:space-x-0">                
                ...
                <div className="sm:w-full dropdown hidden sm:flex sm:flex-col">
                    ...
                    <div className="dropdown-content hidden sm:w-full ">
