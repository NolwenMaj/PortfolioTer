          ...
          <div className="font-display flex sm:flex-row sm:pl-32 sm:py-10 flex-col-reverse items-center sm:justify-between my-20">
            <div className="w-3/4 sm:w-[50%] text-xl text-[#F2511B] flex flex-col justify-center gap-2">
                ...
                <div className="flex flex-row items-center space-x-2 ">
                  ...
                  {projet.github && (
                    ...
                    >
                      ...
                      />
                      <Icon
                        className="hover:animate-bounce invisible sm:visible  text-black"
                ...
                <p className="text-sm sm:text-lg font-light">
                  ...
                  {projet.colleagues && (
                    <span>
                      {" "}
                      - avec{" "}
                      <a target="_blank" href={projet.linkColleagues}>
                        {projet.colleagues}
                      </a>
                    </span>
                  )}{" "}
                  {projet.subtitle && <span> - {projet.subtitle}</span>}
                </p>
                <div className="font-thin sm:text-base py-8 text-black text-xs">
                  {projet.paragraphe1 && (
                    <p className="pt-2">{projet.paragraphe1}</p>
                  )}
                  {projet.paragraphe2 && (
                    <p className="pt-2">{projet.paragraphe2}</p>
                  )}
                  {projet.paragraphe3 && (
                    <p className="pt-2">{projet.paragraphe3}</p>
                  )}
                  {projet.paragraphe4 && (
                    <p className="pt-2">{projet.paragraphe4}</p>
                  )}
                </div>
              </div>
              <div className="flex sm:flex-row sm:flex-wrap gap-4 flex-col">
                {projet.image2 && (
                  <img
                    className="sm:max-w-[45%] max-h-96 rounded-lg border-2 object-contain"
                    src={projet.image2}
              ...
              <div className="flex flex-row gap-2 sm:text-sm text-xs pt-8">
                {projet.themes[0] && (
                  <p className="py-1text-lg font-light ">{projet.themes[0]}</p>
                )}
                {projet.themes[1] && (
                  <p className="py-1text-lg font-light ">{projet.themes[1]}</p>
                )}
                {projet.themes[2] && (
                  <p className="py-1text-lg font-light ">{projet.themes[2]}</p>
                )}
                {projet.themes[3] && (
                  <p className="py-1text-lg font-light ">{projet.themes[3]}</p>
                )}
                {projet.themes[4] && (
                  <p className="py-1text-lg font-light ">{projet.themes[4]}</p>
                )}
                {projet.themes[5] && (
                  <p className="py-1text-lg font-light ">{projet.themes[5]}</p>
                )}
              </div>
            </div>
